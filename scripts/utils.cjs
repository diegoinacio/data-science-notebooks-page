...
function generate_tags(notebook, data) {
  ...
  return [
    ...
    `<meta property="og:url" content="https://diegoinacio.github.io/data-science-notebooks-page/pages/${notebook}.html">`,
    `<meta name="title" property="og:title" content="${data.title} >> Data Science Notebooks | Diego Inácio">`,
    `<meta name="description" property="og:description" content="${data.description}">`,
    `<meta name="image" property="og:image" content="https://diegoinacio.github.io/data-science-notebooks-page/images/thumb_${notebook}.jpg">`,
    `<meta property="og:image:type" content="image/jpeg">`,
    `<meta property="og:type" content="article">`,
    `<meta property="article:author" content="Diego Inácio">`,
    `<meta property="article:section" content="Data Science Notebooks">`,
  ];
}
